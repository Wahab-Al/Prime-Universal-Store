        ...
        <>
            <div className="container-fluid d-none d-md-block bg-body-tertiary rounded rounded-5 p-3 mt-3 mt-md-5">
                ...
                <div className="container-fluid container-md most-bought m-auto mt-2 mt-md-4">
                    <div className="title bg-body-secondary border-1 border-bottom border-end border-secondary rounded rounded-3 m-1 pe-1 pt-2 shadow text-center"><h4 className='mt-4 fs-6 fs-md-4'>Most Bought</h4></div>
